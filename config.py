...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7713796326:AAHNBfas-dYIYGapDRLrghk19tGqdjKay4s") 
...
U_S_E_P = False if (True if os.environ.get('U_S_E_P', "TRUE") == "False" else False) and (USE_SHORTLINK) else False
...
USE_PAYMENT = False if (True if os.environ.get("USE_PAYMENT", "TRUE") == "TRUE" else False) and (USE_SHORTLINK) else False
#UPI ID
